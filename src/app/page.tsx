...
function SiteHeader() {
  return (
    <header className="fixed left-0 right-0 top-4 z-40 px-4">
      <nav className="mx-auto flex max-w-6xl items-center justify-between rounded-full border border-white/10 bg-black/70 px-3 py-2 shadow-[0_0_80px_rgba(255,255,255,0.13)] backdrop-blur-xl">
        <a
          href="#top"
          className="group rounded-full px-3 py-2 text-sm font-semibold tracking-tight transition-colors duration-200 ease-out hover:text-white"
        ...
        <Button
          asChild
          className="h-10 rounded-full bg-white px-4 text-black shadow-[0_0_24px_rgba(255,255,255,0.32)] transition-transform duration-200 ease-out hover:scale-[1.01] hover:bg-white/90"
        >
  ...
  return (
    ...
    >
      <div className="grid items-end gap-10 lg:grid-cols-[1.12fr_0.88fr]">
        <Reveal className="space-y-8" variant="blast">
          <div className="flex flex-wrap items-center gap-3">
            <Badge className="h-8 rounded-full border-white/20 bg-white/10 px-4 text-white shadow-[0_0_36px_rgba(255,255,255,0.16)]">
          ...
          <div className="space-y-6">
            <p className="font-code text-sm uppercase tracking-[0.42em] text-muted-foreground">
              {portfolio.role}
            </p>
            <KineticText
              as="h1"
              text={portfolio.headline}
              className="max-w-5xl text-balance text-6xl tracking-[-0.075em] sm:text-7xl md:text-8xl lg:text-[8.9rem]"
            />
            <p className="max-w-2xl text-pretty text-xl leading-8 text-muted-foreground md:text-2xl md:leading-9">
              {portfolio.hero}
            </p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button
              asChild
              className="h-12 rounded-full bg-white px-6 text-base text-black shadow-[0_0_34px_rgba(255,255,255,0.26)] transition-transform duration-200 ease-out hover:scale-[1.01] hover:bg-white/90"
            >
              <a href="#projects">
                View projects
                <ArrowUpRight />
            ...
            <Button
              asChild
              variant="outline"
              className="h-12 rounded-full border-white/15 bg-white/[0.03] px-6 text-base transition-colors duration-200 ease-out hover:bg-white/[0.08]"
            >
              <a href={`mailto:${portfolio.email}`}>
                <Mail />
                Contact me
        ...
        <Reveal delay={0.12} className="relative" variant="tilt">
          <Hover3D>
            <div className="hover-3d-surface oled-panel relative overflow-hidden rounded-[2.4rem] p-5 text-foreground">
              ...
              <div className="relative rounded-[1.8rem] border border-white/10 bg-black/45 p-5">
                ...
                <div className="space-y-5">
                  <div className="grid grid-cols-3 gap-3">
                    {portfolio.stats.map((stat) => (
                      ...
                      >
                        <p className="font-code text-2xl font-semibold">
                          {stat.value}
                        </p>
                  ...
                  <p className="text-pretty text-2xl font-medium leading-8">
                    {portfolio.summary}
                  </p>
                </div>
              </div>
...
function AboutSection() {
  return (
    <section id="about" className="mx-auto max-w-6xl px-4 py-24 md:px-6">
      <Reveal className="relative" variant="zoom">
        <Hover3D>
